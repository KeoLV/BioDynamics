...
TFimagefolder = 'C:\Path\to\your\desired\output\image\folder\';
...
for trialNum = 1:6
    ...
    trialSetnameGoEpochs = sprintf('trial%d_0712_goepochs.set', trialNum);
    trialSetnameNoGoEpochs = sprintf('trial%d_0712_nogoepochs.set', trialNum);
    ...
    %load go epoch set
    EEG = pop_loadset(trialSetnameGoEpochs, datapath);
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 0, 'setname', trialSetnameGoEpochs, 'gui', 'off');
    [ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG, CURRENTSET);
    %call tfplot function
    tfplot(EEG,labels,trialNum,TFimagefolder,'GoEpochs');

    %load nogo epoch set
    EEG = pop_loadset(trialSetnameNoGoEpochs, datapath);
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 0, 'setname', trialSetnameNoGoEpochs, 'gui', 'off');
    [ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG, CURRENTSET);
    %call tfplot function
